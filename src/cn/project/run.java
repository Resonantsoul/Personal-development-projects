...
public class run extends repeat {
    //run类继承repeat来使用repeat类中的变量和方法（score，number）（method,method1）
    public static void main(String[] args) {    System.out.println("加减乘除计算练习器");
